...
echo "File $DEGITEOR config exist."
...
su -c "echo 'PATH=/home/$DEGITEOR/.meteor:/home/$DEGITEOR/.nvm/bin/node-$NVM_VER-linux-x64:/home/$DEGITEOR/node_modules/forever/bin:/home/$DEGITEOR/node_modules/demeteorizer/bin:/home/$DEGITEOR/.nvm/$NVM_VER/bin:$PATH' >>/home/$DEGITEOR/.profile" $DEGITEOR
...
su -c  " export ROOT_URL=$ROOT_URL && export MONGO_URL=$MONGO_URL && export PORT=$PORT && export MAIL_URL=$MAIL_URL && . /home/$DEGITEOR/.profile && cd /home/$DEGITEOR &&  /home/$DEGITEOR/node_modules/forever/bin/forever start /home/$DEGITEOR/my-meteor-deployment/bundle/main.js" $DEGITEOR
#END
fi
done
