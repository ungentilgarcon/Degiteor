...
#the rest
 su -c ". /home/$DEGITEOR/.profile && cd /home/$DEGITEOR && npm install demeteorizer forever npm-install-missing fibers underscore source-map-support semver" $DEGITEOR
...
su -c  " export ROOT_URL=$ROOT_URL && export MONGO_URL=$MONGO_URL && export PORT=$PORT && . /home/$DEGITEOR/.profile && cd /home/$DEGITEOR &&  /home/$DEGITEOR/node_modules/forever/bin/forever start /home/$DEGITEOR/my-meteor-deployment/bundle/main.js" $DEGITEOR
#END
fi
done
